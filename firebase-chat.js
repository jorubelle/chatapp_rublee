(function () {
  // TODO: replace this with your own firebase config object after creating app in your firebase console DONE
  // Your web app's Firebase configuration
  const firebaseConfig = {
    apiKey: "AIzaSyC6XrG7tWa2IRzUL5NXpT0a04fIstMrrZQ",
    authDomain: "chatapp-78325.firebaseapp.com",
    databaseURL: "https://chatapp-78325-default-rtdb.firebaseio.com",
    projectId: "chatapp-78325",
    storageBucket: "chatapp-78325.appspot.com",
    messagingSenderId: "271958604412",
    appId: "1:271958604412:web:3624a5a4fa8faf2cfea7f9",
    measurementId: "G-VEFJJX5PZS"
  };
  // Initialize Firebase
  ...
  write.addEventListener('click', (e) => {
    ...
    messages
      .child(id)
      .set({ sender: currentUserEmail , message: message.value })
      .then(function () {
